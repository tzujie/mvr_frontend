...
const LoginRegister: React.FC = () => {
    ...
    const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await axios.post('https://f648-163-13-201-95.ngrok-free.app/api/login/', data, {
                headers: {
    ...
    const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await axios.post('https://f648-163-13-201-95.ngrok-free.app/api/register/', data, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
