...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  ...
  test.describe(title('datetime-button: labels'), () => {
    ...
    test('should update the label when the value of the datetime changes', async ({ page }) => {
      ...
      await datetime.evaluate((el) => (el.value = '2023-05-10'));
      await page.waitForChanges();
  ...
  test.describe(title('datetime-button: wheel'), () => {
    test('should only show a single date button when presentation="date-time" and prefer-wheel="true"', async ({ page, }) => {
      await page.setContent(`
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
    ...
    test('should only show a single date button when presentation="time-date" and prefer-wheel="true"', async ({ page, }) => {
      await page.setContent(`
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
